...
class NNModel:
    ...
    def view_batch(self):
        ...
        """
        # i = 0
        # for each_image, each_label in self.trainloader:
        #     print(each_image.shape)
        #     print(each_image)
        #     for each in each_image:
        #         print(each.shape)
        #         plt.imshow(each[0], cmap='Greys')
        #         plt.show()
        #         i += 1
        #         if i >= 3:
        #             return
        ...
        #     # print(each_label)
        #     # return
        x = iter(self.trainloader)
        images, labels = x.next()
        img_res = np.zeros((28*8, 28*8))
        i = 0
        j = 0
        for each_image in images:
            if i >= 8:
                ...
                i = 0
            # print(i, j)
            img_res[j*28:(j+1)*28, i*28:(i+1)*28] = each_image[0]
            i += 1
        label_res = labels.reshape((8,8)).numpy()
        # plt.imshow(img_res, cmap='Greys')
        # plt.show()
